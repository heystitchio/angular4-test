...
import * as import7 from './user-routing.module';
import * as import8 from './single/single-user.component.ngfactory';
import * as import9 from './single/single-user.component';
class UserModuleInjector extends import0.ɵNgModuleInjector<import1.UserModule> {
  ...
  _UserRoutingModule_6:import7.UserRoutingModule;
  _UserModule_7:import1.UserModule;
  __NgLocalization_8:import2.NgLocaleLocalization;
  __FormBuilder_9:import4.FormBuilder;
  __ɵi_10:import4.ɵi;
  __ROUTES_11:any[];
  constructor(parent:import0.Injector) {
    super(parent,[import8.SingleUserComponentNgFactory],([] as any[]));
  }
  ...
  get _ROUTES_11():any[] {
        if ((this.__ROUTES_11 == null)) { (this.__ROUTES_11 = [[{
          path: 'user/:slug',
          component: import9.SingleUserComponent
        }
    ]]); }
  ...
  createInternal():import1.UserModule {
    ...
    this._UserRoutingModule_6 = new import7.UserRoutingModule();
    this._UserModule_7 = new import1.UserModule();
    return this._UserModule_7;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import7.UserRoutingModule)) { return this._UserRoutingModule_6; }
    if ((token === import1.UserModule)) { return this._UserModule_7; }
